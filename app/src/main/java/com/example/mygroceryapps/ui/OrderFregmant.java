...
import com.example.mygroceryapps.Model.MyorderModel;
import com.example.mygroceryapps.R;
import com.example.mygroceryapps.adapters.OrderAdapter;
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        ...
                        orderItemList.add( new MyorderModel(dataSnapshot.getKey(),"   Date :  " + Date ,"   Products Number :  "+String.valueOf(nums),"   Total Price :  "+ totalPrice+" TK" , "   "+products,OrderCheck));
                    }
                }
                else{
                    orderItemList.clear();
